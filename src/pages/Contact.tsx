        ...
        <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4"><div className="flex h-12 w-12 items-center justify-center bg-brand-red text-white"><User className="h-5 w-5" /></div><div><p className="text-xs font-bold uppercase tracking-[0.25em] text-brand-red">Contact Person</p><p className="mt-2 text-2xl font-extrabold text-brand-dark">Jobi K Pailie</p><p className="mt-1 text-brand-dark/60">Managing Director - FMCG Distribution Sales & Marketing</p></div></div>
